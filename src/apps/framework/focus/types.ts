...
export function normalizeFocusableRegistration(input: FocusableRegistration): NormalizedFocusableRegistration {
...
export type FocusNavigationParticipant = Pick<FocusableRegistration, "captureSnapshot" | "restoreSnapshot">
