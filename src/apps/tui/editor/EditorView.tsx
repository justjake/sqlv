...
function EditorSurface(props: {
  ...
  }, [focused, completion.status, onApplyCompletionItem, onCloseCompletion, onFocusCompletionItem, renderer])
  ...
  const flyoutLayout = computeSuggestionMenuLayout(completion, containerRef.current, textareaRef.current)
  const analysisOverlay = getEditorAnalysisOverlay(visibleAnalysis, text, textareaRef.current, focused)
