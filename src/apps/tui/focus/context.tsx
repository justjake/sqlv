...
const FocusNavigationRestoreContext = createContext<((skipRestoreOnExit: boolean) => void) | undefined>(undefined)
...
export function useFocusedDescendantSubpath(): FocusPathSuffix | undefined {
  ...
  return useMemo(() => (path ? focusPathSubpath(path, descendantPath) : undefined), [descendantPath, path])
}
...
function createFocusHaloOverlayPresentation(target: FocusHaloOverlayTarget): FocusHaloOverlayPresentation | null {
...
function sameFocusHaloOverlayTarget(a: FocusHaloOverlayTarget | null, b: FocusHaloOverlayTarget | null): boolean {
  return (
